...
import { labels, getLabelColor } from "./MessageLabels";
...
export class MailItem extends Component {
  ...
  componentDidMount() {
    ...
    // console.log("Received messages", this.props.messages)
  }
    ...
    const locale = {
      emptyText: (
        <div className="text-center my-5">
          ...
          <h3 className="mt-3 font-weight-light">There is no messages</h3>
        </div>
      ),
    };
